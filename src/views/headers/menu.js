    ...
    render() {
        return html`
            ...
            <div id="opciones" class="grid column" @click=${this.toggleMenu}>
                ...
                <div class="menuItem seleccionado" @click=${this.click} .option=${"registroIngreso"}>Registrar ingresos</div>
                <div class="menuItem" @click=${this.click} .option=${"controlEgreso"}>Registrar egresos</div>
                <div class="menuItem" @click=${this.click} .option=${"consulta"}>Consulta</div>
                <div class="menuItem" @click=${this.click} .option=${"cierre"}>Parte diario</div>
